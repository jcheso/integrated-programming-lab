// Testing copying this file from Windows to Remote Linux Server
...
int main()
{
	int year_now, age_now, another_year, another_age, month_now, month_born, another_month, another_age_month;
	...
	another_age_month = another_month - (month_now - month_born);

	if (another_age >= 0 && another_age <= 150)
	{
		cout << "Your age in " << another_month << "/" << another_year << ": ";

		if (another_age_month < 2)
		{
			cout << another_age << "years and " << another_age_month << "month"
				 << "\n";
		}
		else
		{
			cout << another_age << "years and " << another_age_month << "months"
				 << "\n";
		}
	}
	else if (another_age > 150)
	{
		cout << "Sorry by you'll probably be dead by " << another_year << "\n";
	}
	else
	{
